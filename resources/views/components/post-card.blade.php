<article class="bg-white dark:bg-[#1C1926] border border-orange-100/50 dark:border-white/5 rounded-[2.5rem] overflow-hidden shadow-xl shadow-orange-900/5 dark:shadow-black/10 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-orange-900/10">
    ...
    <div class="p-5 sm:p-6 flex items-start justify-between">
        ...
        <div x-data="{ shareOpen: false }" class="relative z-50 shrink-0 ml-4">
            ...
            <div x-show="shareOpen" x-transition.opacity.duration.200ms style="display: none;" class="absolute right-0 mt-2 w-48 bg-white dark:bg-[#2A2635] rounded-2xl shadow-xl border border-orange-100 dark:border-white/10 py-2 overflow-hidden">
                ...
                <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(route('posts.show', $post)) }}&title={{ urlencode($post->title) }}" target="_blank" class="flex items-center gap-3 px-4 py-2 text-sm font-bold text-[#8C7A6B] dark:text-gray-300 hover:text-[#0A66C2] dark:hover:text-[#0A66C2] hover:bg-orange-50 dark:hover:bg-white/5 transition-colors">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                    LinkedIn
                </a>
                <a href="https://reddit.com/submit?url={{ urlencode(route('posts.show', $post)) }}&title={{ urlencode($post->title) }}" target="_blank" class="flex items-center gap-3 px-4 py-2 text-sm font-bold text-[#8C7A6B] dark:text-gray-300 hover:text-[#FF4500] dark:hover:text-[#FF4500] hover:bg-orange-50 dark:hover:bg-white/5 transition-colors">
    ...
    <div class="px-5 py-4 sm:px-6 flex flex-wrap gap-4 items-center justify-between border-t border-orange-50/50 dark:border-white/5 bg-white/50 dark:bg-transparent">
