    ...
    <div class="max-w-[800px] mx-auto bg-white/70 dark:bg-[#1C1926]/70 backdrop-blur-xl border border-orange-100/50 dark:border-white/5 shadow-[0_8px_30px_rgb(120,60,20,0.05)] dark:shadow-none rounded-[2rem] px-4 sm:px-6 h-16 flex items-center justify-between transition-all">
        ...
        <div class="flex items-center gap-2 sm:gap-4">
            <button id="theme-toggle" @click="theme = theme === 'dark' ? 'light' : 'dark'; localStorage.setItem('theme', theme)"
                    class="p-2.5 rounded-2xl bg-white/50 dark:bg-white/5 backdrop-blur-md border border-orange-100/50 dark:border-white/10 shadow-sm hover:bg-white/80 dark:hover:bg-white/10 transition-all text-orange-500 dark:text-orange-300">
