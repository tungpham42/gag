...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-[#1C1926] rounded-[2.5rem] border border-orange-50 dark:border-white/5 shadow-xl p-4 sm:p-6">

        <div class="overflow-x-auto">
            <table id="all-posts-table" class="w-full min-w-full whitespace-nowrap text-left">
                <thead>
                ...
                <tbody class="divide-y divide-orange-50 dark:divide-white/5">
                    ...
                    <tr class="hover:bg-orange-50/50 dark:hover:bg-white/[0.02] transition-colors">
                        <td class="px-4 py-3">
                            <div class="w-14 h-14 rounded-2xl overflow-hidden bg-gray-100 dark:bg-black shadow-inner min-w-[3.5rem]">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                <img src="{{ $post->user->avatar }}" class="w-6 h-6 rounded-lg min-w-[1.5rem]">
